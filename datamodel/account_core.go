...
Account_DealtCA   = "DealtCA" // DealtCA is a String
Account_AgainstCA   = "AgainstCA" // AgainstCA is a String
Account_LedgerCA   = "LedgerCA" // LedgerCA is a String
Account_CashBalanceCA   = "CashBalanceCA" // CashBalanceCA is a String
