...
func CounterpartyExtensions_Store(r dm.CounterpartyExtensions) error {
	...
	adaptor.CounterpartyExtensions_Delete(r.CompID)
	adaptor.CounterpartyExtensions_Update(r)
