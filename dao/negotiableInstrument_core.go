...
func NegotiableInstrument_GetList() (int, []dm.NegotiableInstrument, error) {
	...
	tsql := "SELECT * FROM " + get_TableName(core.ApplicationSQLSchema(), dm.NegotiableInstrument_SQLTable)
...
func NegotiableInstrument_Delete(id string) {
	...
	object_Table := core.ApplicationSQLSchema() + "." + dm.NegotiableInstrument_SQLTable
...
func negotiableinstrument_Save(r dm.NegotiableInstrument, usr string) error {
	...
	tsql := "INSERT INTO " + get_TableName(core.ApplicationSQLSchema(), dm.NegotiableInstrument_SQLTable)
	tsql = tsql + " (" + fields(ts) + ")"
