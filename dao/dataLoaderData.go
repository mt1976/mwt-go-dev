...
func DataLoaderData_Store(r dm.DataLoaderData) error {
...
//Deal with the if its Application or null add this bit, otherwise dont.
	...
	ts = addData(ts, dm.DataLoaderData_Loader_Impl, r.Loader_Impl)
	ts = addData(ts, dm.DataLoaderData_LoaderDescription_Impl, r.LoaderDescription_Impl)
	ts = addData(ts, dm.DataLoaderData_LoaderType_Impl, r.LoaderType_Impl)
