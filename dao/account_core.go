...
func account_Save(r dm.Account, usr string) error {
	...
	account_DealtCA_Extra_Store(r, r.DealtCA_Extra)
	account_AgainstCA_Extra_Store(r, r.AgainstCA_Extra)
	account_LedgerCA_Extra_Store(r, r.LedgerCA_Extra)
	account_CashBalanceCA_Extra_Store(r, r.CashBalanceCA_Extra)
