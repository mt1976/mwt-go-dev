...
func DataLoaderMap_Store(r dm.DataLoaderMap) error {
...
//Deal with the if its Application or null add this bit, otherwise dont.
	...
	ts = addData(ts, dm.DataLoaderMap_Loader_Impl, r.Loader_Impl)
	ts = addData(ts, dm.DataLoaderMap_LoaderDescription_Impl, r.LoaderDescription_Impl)
	ts = addData(ts, dm.DataLoaderMap_LoaderType_Impl, r.LoaderType_Impl)
