...
func UserRole_GetList() (int, []dm.UserRole, error) {
	...
	tsql := "SELECT * FROM " + get_TableName(core.ApplicationPropertiesDB["schema"], dm.UserRole_SQLTable)
...
func UserRole_Delete(id string) {
	...
	object_Table := core.ApplicationPropertiesDB["schema"] + "." + dm.UserRole_SQLTable
...
//Deal with the if its Application or null add this bit, otherwise dont.
	...
	tsql := "INSERT INTO " + get_TableName(core.ApplicationPropertiesDB["schema"], dm.UserRole_SQLTable)
	tsql = tsql + " (" + fields(ts) + ")"
