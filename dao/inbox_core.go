...
func Inbox_Delete(id string) {
	...
	object_Table := core.ApplicationPropertiesDB["schema"] + "." + dm.Inbox_SQLTable
...
//Deal with the if its Application or null add this bit, otherwise dont.
	...
	tsql := "INSERT INTO " + get_TableName(core.ApplicationPropertiesDB["schema"], dm.Inbox_SQLTable)
	tsql = tsql + " (" + fields(ts) + ")"
