/****** Object:  View [{{!SQL.SCHEMA}}].[sienaBIcounterpartyPerSector]    Script Date: 09/05/2021 14:36:12 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[25] 4[27] 2[21] 3) )"
      End
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaBIcounterpartyPerSector'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaBIcounterpartyPerSector'
GO
