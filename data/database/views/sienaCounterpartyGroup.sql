/****** Object:  View [{{!SQL.SCHEMA}}].[sienaCounterpartyGroup]    Script Date: 09/05/2021 14:36:12 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaCounterpartyGroup'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaCounterpartyGroup'
GO
