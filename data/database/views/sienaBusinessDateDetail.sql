/****** Object:  View [{{!SQL.SCHEMA}}].[sienaBusinessDateDetail]    Script Date: 09/05/2021 14:36:12 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "BusinessDate"
            ...
            TopColumn = 11
         End
         Begin Table = "sienaBusinessDate ({{!SQL.SCHEMA}})"
            Begin Extent = 
               Top = 6
               Left = 292
               Bottom = 186
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaBusinessDateDetail'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaBusinessDateDetail'
GO
