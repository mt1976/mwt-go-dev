...
func DealConversation_Delete(id string) {
	//application.LOG_message("DealConversation_Delete", "Doing it!")
	//application.LOG_message("DealConversation_Delete", "Done it!")
	message:= "DealConversation_Delete: " + id
	logs.Success(message)
}

func DealConversation_Update(item dm.DealConversation) {
	//application.LOG_message("DealConversation_Import", "Doing it!")
	//application.LOG_message("DealConversation_Import", "Done it!")
	message:= "DealConversation_Update: " + item.MessageLogReference
	logs.Success(message)
}


func DealConversation_BuildMessage(item dm.DealConversation) {
