/****** Object:  View [{{!SQL.SCHEMA}}].[sienaReportingEntities]    Script Date: 09/05/2021 14:36:12 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "SystemCounterparty"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 226
            ...
            TopColumn = 0
         End
         Begin Table = "SystemCounterpartyExtensions"
            Begin Extent = 
               Top = 6
               Left = 281
               Bottom = 226
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaReportingEntities'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'{{!SQL.SCHEMA}}', @level1type=N'VIEW',@level1name=N'sienaReportingEntities'
GO
