USE [RG3]
GO
/****** Object:  View [{{!SQL.SCHEMA}}].[sienaAccount]    Script Date: 13/10/2021 18:25:58 ******/
SET ANSI_NULLS ON
GO
...
SELECT        {{!SQL.SOURCE}}.Deals.SienaReference, {{!SQL.SOURCE}}.Deals.CustomerSienaView, {{!SQL.SOURCE}}.Deals.SienaCommonRef, {{!SQL.SOURCE}}.Deals.Status, {{!SQL.SOURCE}}.Deals.StartDate, {{!SQL.SOURCE}}.Deals.MaturityDate, {{!SQL.SOURCE}}.Deals.ContractNumber, {{!SQL.SOURCE}}.Deals.ExternalReference,
                         ...
                         {{!SQL.SOURCE}}.Deals.AgreementId, {{!SQL.SOURCE}}.Deals.BackOfficeRefNo, {{!SQL.SOURCE}}.Deals.ISIN, {{!SQL.SOURCE}}.Deals.UTI, {{!SQL.SOURCE}}.Currency.Name AS CCYName, {{!SQL.SOURCE}}.Book.FullName AS BookName,
